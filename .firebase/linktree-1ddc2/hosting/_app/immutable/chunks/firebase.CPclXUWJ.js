import{d as pd,w as os}from"./index.yQvOGfyo.js";var la={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(rf(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function rf(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const us="@firebase/app",ma="0.9.28";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qf(t){Tt(new tt("platform-logger",e=>new nf(e),"PRIVATE")),Tt(new tt("heartbeat",e=>new Ff(e),"PRIVATE")),Ce(us,ma,t),Ce(us,ma,"esm2017"),Ce("fire-js","")}qf("");var $f="firebase",zf="10.8.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fd="storage";function kT(t,e,n){return t=B(t),JE(t,e,n)}function DT(t){return t=B(t),YE(t)}function NT(t,e){return t=B(t),nT(t,e)}function iT(t=js(),e){t=B(t);const r=ti(t,fd).getImmediate({identifier:e}),i=qc("storage");return i&&sT(r,...i),r}function sT(t,e,n,r={}){rT(t,e,n,r)}function oT(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new ua(n,r,i,e,Pt)}function aT(){Tt(new tt(fd,oT,"PUBLIC").setMultipleInstances(!0)),Ce(Mc,xc,""),Ce(Mc,xc,"esm2017")}aT();const cT={apiKey:"AIzaSyBDYKsYdZcFLUfNy-Z4c8G-BPqlBozdJls",authDomain:"linktree-1ddc2.firebaseapp.com",projectId:"linktree-1ddc2",storageBucket:"linktree-1ddc2.appspot.com",messagingSenderId:"546522310296",appId:"1:546522310296:web:850f123dbcd946e12e12ed"};Qc(cT);const uT=x_(),fn=Qv(),VT=iT();function lT(){let t;if(!fn||!globalThis.window){console.warn("Auth is not initialized or not in browser");const{subscribe:n}=os(null);return{subscribe:n}}const{subscribe:e}=os((fn==null?void 0:fn.currentUser)??null,n=>(t=Uy(fn,r=>{n(r)}),()=>t()));return{subscribe:e}}const hT=lT();function dT(t){let e;const n=L_(uT,t),{subscribe:r}=os(null,i=>(e=W_(n,s=>{i(s.data()??null)}),()=>e()));return{subscribe:r,ref:n,id:n.id}}const OT=pd(hT,(t,e)=>{if(t)return dT(`users/${t.uid}`).subscribe(e);e(null)});export{Ge as G,hT as a,CT as b,fn as c,VT as d,kT as e,AT as f,DT as g,L_ as h,uT as i,TT as j,_T as k,ET as l,vT as m,IT as n,RT as o,ST as p,yT as q,NT as r,bT as s,wT as t,OT as u,PT as w};
